...
export const ru: Dictionary = {
  actions: {
    ...
    createCustomExerciseConfirm: "Создать упражнение",
    collapse: "Свернуть",
  ...
  labels: {
    ...
    authVerificationHint: "Подтвердите почту по ссылке из письма, чтобы закончить регистрацию",
    authVerificationPending: "Почта не подтверждена",
    authVerificationSent: "Письмо для подтверждения отправлено",
    allMuscleGroups: "Все",
    customExerciseCategories: "Категории",
    customExerciseName: "Название упражнения",
