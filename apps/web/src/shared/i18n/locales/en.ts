...
export const en: Dictionary = {
  actions: {
    ...
    createCustomExerciseConfirm: "Create exercise",
    collapse: "Collapse",
    ...
    reset: "Reset",
    register: "Register",
    resendVerificationEmail: "Send the email again",
  ...
  labels: {
    ...
    accountGuestConnected: "Guest account connected",
    accountLocalOnly: "Local-only mode",
    authEmail: "Email",
    authPassword: "Password",
    authRegisteredHint: "Registration will attach your current workout data to this account",
    authRegisterHint: "Create an account or log in to keep your data under email access",
    authVerificationHint: "Confirm your email from the link in the message to finish registration",
    authVerificationPending: "Email is not verified",
    authVerificationSent: "Verification email has been sent",
    allMuscleGroups: "All",
