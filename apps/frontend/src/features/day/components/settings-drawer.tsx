			...
			<DrawerContent className="mx-auto max-h-[92svh] max-w-md rounded-b-2xl bg-background/98 backdrop-blur">
				...
				<div className="min-h-0 flex-1 space-y-5 overflow-y-auto overscroll-contain px-4 pb-4">
					...
					<SettingsSegment<ThemeMode>
						...
						options={[
							{
								label: dictionary.labels.themeSystem,
								value: 'system',
							},
							{
								label: dictionary.labels.themeLight,
								value: 'light',
							},
							{
								label: dictionary.labels.themeDark,
								value: 'dark',
							},
						]}
					...
					<SettingsSegment<WeightUnit>
						...
						options={[
							{
								label: dictionary.units.kg,
								value: 'kg',
							},
							{
								label: dictionary.units.lb,
								value: 'lb',
							},
						]}
